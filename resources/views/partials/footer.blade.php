    ...
    >
      <div class="container text-center">
        <p class="mb-0">
          &copy;
          <a class="text-white border-bottom" href="#">Airsoft Zone</a>. All
    ...
    <script src="{{ url('js/lib/easing/easing.min.js') }}"></script>
    <script src="{{ url('js/lib/waypoints/waypoints.min.js') }}"></script>
    <script src="{{ url('js/lib/counterup/counterup.min.js') }}"></script>
    <script src="{{ url('js/lib/owlcarousel/owl.carousel.min.js') }}"></script>
