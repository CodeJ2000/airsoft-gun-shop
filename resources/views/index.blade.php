      ...
      <div class="container py-5">
        <div class="row justify-content-start">
          <div class="col-lg-8 text-center text-lg-start">
            <h1 class="font-secondary text-primary mb-4">30% OFF</h1>
            <h1 class="display-1 text-uppercase text-white mb-4">
              Airsoft Zone
            </h1>
            <h1 class="text-uppercase text-white">Summer Sale</h1>
            <div
            ...
            >
              ...
              <button
                ...
                data-src="https://www.youtube.com/embed/xtKtT2jZG1o"
    ...
    <div class="container-fluid pt-5">
      <div class="container">
        ...
        >
          ...
          <h1 class="display-4 text-uppercase">Welcome To Airsoft Zone</h1>
        </div>
        <div class="row gx-5">
          <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 400px">
            <div class="position-relative h-100">
              <img
                ...
                src="img/airsoft-about-profile.png"
    ...
    <div class="container-fluid about py-5">
      <div class="container">
        ...
        >
          ...
          <h1 class="display-4 text-uppercase">Airsoft Guns</h1>
        </div>
    ...
    <div class="container-fluid about py-5">
      <div class="container">
        <div
          ...
          style="max-width: 600px"
        >
          <h1 class="display-4 text-uppercase">Airsoft Accessories</h1>
        </div>
        <div class="tab-class text-center">
          <ul
            class="nav nav-pills d-inline-flex justify-content-center bg-dark text-uppercase border-inner p-4 mb-5"
    ...
    <div class="container-fluid py-5">
      <div class="container">
        <div
          ...
          style="max-width: 600px"
        >
          <!-- <h2 class="text-primary font-secondary">Top Brands</h2> -->
          <h1 class="display-4 text-uppercase">Top Brands</h1>
        </div>
        <div class="row g-5">
          <div class="col-lg-4 col-md-6">
            <div class="team-item">
              <div class="position-relative overflow-hidden">
                <img class="img-fluid w-100" src="img/brand-1.jpg" alt="" />
                <div
              ...
              <div class="bg-dark border-inner text-center p-4">
                <h4 class="text-uppercase text-primary">ICS Airsoft</h4>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="team-item">
              <div class="position-relative overflow-hidden">
                <img class="img-fluid w-100" src="img/brand-2.jpg" alt="" />
                <div
                  class="team-overlay w-100 h-100 position-absolute top-50 start-50 translate-middle d-flex align-items-center justify-content-center"
                >
                  <div class="d-flex align-items-center justify-content-start">
              ...
              <div class="bg-dark border-inner text-center p-4">
                <h4 class="text-uppercase text-primary">Tokyo Marui</h4>
                <!-- <p class="text-white m-0">Designation</p> -->
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="team-item">
              <div class="position-relative overflow-hidden">
                <img class="img-fluid w-100" src="img/brand-3.png" alt="" />
                <div
                  class="team-overlay w-100 h-100 position-absolute top-50 start-50 translate-middle d-flex align-items-center justify-content-center"
                >
                  <div class="d-flex align-items-center justify-content-start">
              ...
              <div class="bg-dark border-inner text-center p-4">
                <h4 class="text-uppercase text-primary">Double Bell</h4>
                <!-- <p class="text-white m-0">Designation</p> -->
              </div>
            </div>
          </div>
        ...
        <div class="row gx-5 justify-content-center">
          <div class="col-lg-7 text-center">
            <div
              ...
              style="max-width: 600px"
            >
              <h2 class="text-primary font-secondary">30% Sales this summer</h2>
